...
#
# make lfuses = Make and write low fuses
#
# make hfuses = Make and write high fuses
#
# make efuses = Make and write efuses
#
...
# Write fuses
AVRDUDE_WRITE_LFUSE = -U lfuse:w:0x3b:m
AVRDUDE_WRITE_HFUSE = -U hfuse:w:0xff:m
