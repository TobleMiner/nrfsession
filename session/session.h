...
#define SESSION_PACKET_INIT_LEN	HEADER_LENGTH + CHALLENGE_LENGTH + ADDRESS_LENGTH + IV_LENGTH + KEYID_LENGTH
#define SESSION_PACKET_AUTH_LEN	HEADER_LENGTH + CHALLENGE_LENGTH + IV_LENGTH + HMAC_LENGTH
#define SESSION_PACKET_DATA_LEN	HEADER_LENGTH + DATA_LENGTH_LENGTH + DATA_LENGTH + HMAC_LENGTH

#define SESSION_PACKET_CHALLENGE_OFFSET		CHALLENGE_LENGTH
#define SESSION_PACKET_ADDRESS_OFFSET		HEADER_LENGTH + CHALLENGE_LENGTH
#define SESSION_PACKET_INIT_IV_OFFSET		HEADER_LENGTH + CHALLENGE_LENGTH + ADDRESS_LENGTH
#define SESSION_PACKET_AUTH_IV_OFFSET		HEADER_LENGTH + CHALLENGE_LENGTH
#define SESSION_PACKET_INIT_KEYID_OFFSET	HEADER_LENGTH + CHALLENGE_LENGTH + ADDRESS_LENGTH + IV_LENGTH
#define SESSION_PACKET_NEW_HMAC_OFFSET		HEADER_LENGTH + CHALLENGE_LENGTH + IV_LENGTH
